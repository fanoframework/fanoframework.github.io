...
```
hello-world/src/App/Hello/Views/Factories/HelloViewFactories.pas`
```
with content as follows
...
Save it and exit. What code above does is tells Apache to allow access to `http://hello-world-fano` and map it to directory "/home/jon/fano-examples/hello-world/public" and for every request to resources which is actual files and directory, it tells Apache to serve them, but other resources requested, pass them to our application binary.
